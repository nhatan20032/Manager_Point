        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Performance = table.Column<int>(type: "int", maxLength: 5, nullable: false),
                    Status = table.Column<int>(type: "int", maxLength: 5, nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AcademicPerformances_GradePoints_GradePointId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AcademicPerformances_GradePointId",
                table: "AcademicPerformances",
                column: "GradePointId");

            migrationBuilder.CreateIndex(
                name: "IX_AcademicPerformances_Id",
                table: "AcademicPerformances",
                column: "Id",
                unique: true);
