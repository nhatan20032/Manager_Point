...
{
    /// <inheritdoc />
    public partial class new_migration_v1 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SchoolYearStart = table.Column<DateTime>(type: "datetime2", nullable: true),
                    SchoolYearEnd = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Classes_GradeLevels_GradeId",
                        column: x => x.GradeId,
